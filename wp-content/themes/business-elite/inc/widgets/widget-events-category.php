...
add_action('widgets_init', 'business_elite_widget_events_category');
function business_elite_widget_events_category(){
  return register_widget("business_elite_events_categ");
}
?>